...
public class L2Activity extends AppCompatActivity {
    ...
    String jumlahSkor;
//ubah
    DBSoal soall2 = new DBSoal();

    //FIREBASE
    public static final String EXTRA_NILAI2 = "extra_nilai2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ADMOB BANNER
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) AdView mAdView = findViewById(R.id.adView);
        ...
        nilai2 = new Nilai();
        nilai2 = getIntent().getParcelableExtra(EXTRA_NILAI2);
    ...
    private void ubahGambar() {
        ...
        //ubah
        jawaban = soall2.getPertanyaan_dua(x);
    ...
    private void skorMinim() {
        ...
        if(SkorMinim >= 70){
            ...
            //ubah
            Toast.makeText(L2Activity.this, "Minimal skor untuk lanjut level 3 adalah \b 70", Toast.LENGTH_LONG).show();
            finish();
        }
    }
