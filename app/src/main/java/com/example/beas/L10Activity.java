...
public class L10Activity extends AppCompatActivity {
    ...
    //FIREBASE
    public static final String EXTRA_NILAI10 = "extra_nilai10";
    private Nilai nilai10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nilai10 = new Nilai();
        nilai10 = getIntent().getParcelableExtra("extra-nilai10");
    ...
    private void ubahGambar() {
        ...
        //ubah
        jawaban = soal.getPertanyaan_sapuluh(x);
        cekPhoto();
    ...
    private void cekPhoto() {
        switch (jawaban) {
            case "budak leutik bisa ngapung":
                mPhoto = "sepuluh_satu";
                break;
            case "Hirup kudu silih asih":
                mPhoto = "sepuluh_dua";
                break;
            case "Moal ngejat sanajan ukur satapak":
                mPhoto = "sepuluh_tiga";
                break;
            case "Numpes musuh sarakah":
                mPhoto = "sepuluh_empat";
                break;
            case "Larak lirik ningali ka bumi":
                mPhoto = "sepuluh_lima";
                break;
            case "Mungguh nu hirup di dunya":
                mPhoto = "sepuluh_enam";
                break;
            case "Henteu puguh nu dijugjug":
                mPhoto = "sepuluh_tujuh";
                break;
            case "Naha naon dosa kula":
                mPhoto = "sepuluh_delapan";
                break;
            case "Nyiar bogo meunang kadal":
                mPhoto = "sepuluh_sembilan";
                break;
            case "Di wétan pajar balébat":
                mPhoto = "sepuluh_sepuluh";
                break;
            default:
                mPhoto = jawaban;
                break;
    ...
    private void submitSkor(Nilai nilai_10) {
        /**
         ...
         */
        //ubah
        nilai10.setSkor_10(jumlahSkor);
        database.child(nilai_10.getNamaUser()).child("level 10").setValue(nilai_10.getSkor_10());
    }
