...
public class L8Activity extends AppCompatActivity {
    ...
    //FIREBASE
    public static final String EXTRA_NILAI8 = "extra_nilai8";
    private Nilai nilai8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nilai8 = new Nilai();
        nilai8 = getIntent().getParcelableExtra("extra-nilai8");
    ...
    private void ubahGambar() {
        ...
        //ubah
        jawaban = soal.getPertanyaan_dalapan(x);
    ...
    private void skorMinim() {
        ...
        if(SkorMinim >= 70){
            Toast.makeText(L8Activity.this, "Anda bisa lanjut ke LEVEL 9", Toast.LENGTH_LONG).show();

            SharedPreferences preferences = getSharedPreferences("PREFS8",0);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("SkorLulus8", SkorMinim);
            editor.apply();
            ...
            Toast.makeText(L8Activity.this, "Minimal skor untuk lanjut level 9 adalah \b70\b", Toast.LENGTH_LONG).show();
            finish();
        }
    }

    private void submitSkor(Nilai nilai_8) {
        /**
         ...
         */
        //ubah
        nilai8.setSkor_8(jumlahSkor);
        database.child(nilai_8.getNamaUser()).child("level 8").setValue(nilai_8.getSkor_8());
    }
