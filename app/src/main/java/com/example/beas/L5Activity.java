...
public class L5Activity extends AppCompatActivity {
    ...
    private void ubahGambar() {
        ...
        //ubah
        jawaban = soal.getPertanyaan_lima(x);
    ...
    private void Selesai() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(L5Activity.this);
        alertDialog.setTitle(" Nilai Kamu : " + jumlahSkor);
        final EditText inputNama = new EditText(L5Activity.this);
        ...
        alertDialog.setPositiveButton("Ok", (dialogInterface, i) -> {
            ...
            if(SkorMinim >= 70){
                Toast.makeText(L5Activity.this, "Anda bisa lanjut LEVEL", Toast.LENGTH_LONG).show();
...
//                editor.apply();
                ...
                Toast.makeText(L5Activity.this, "Minimal skor untuk lanjut level adalah \b 70", Toast.LENGTH_LONG).show();
                finish();
            }
        });
        alertDialog.show();
