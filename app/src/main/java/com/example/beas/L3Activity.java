...
public class L3Activity extends AppCompatActivity {
    ...
    private void Selesai() {
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(L3Activity.this);
        alertDialog.setTitle(" Nilai Kamu : " + jumlahSkor);
        final EditText inputNama = new EditText(L3Activity.this);
        ...
        alertDialog.setPositiveButton("Ok", (dialogInterface, i) -> {
            ...
            if(SkorMinim >= 70){
                Toast.makeText(L3Activity.this, "Anda bisa lanjut LEVEL 4", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(L3Activity.this, "Minimal skor untuk lanjut level adalah \b 70", Toast.LENGTH_LONG).show();
                finish();
            }
        });
        alertDialog.show();
