...
public class L6Activity extends AppCompatActivity {
    ...
    //FIREBASE
    public static final String EXTRA_NILAI6 = "extra_nilai6";
    private Nilai nilai6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nilai6 = new Nilai();
        nilai6 = getIntent().getParcelableExtra("extra-nilai6");
    ...
    private void ubahGambar() {
        ...
        //ubah
        jawaban = soal.getPertanyaan_enam(x);
    ...
    private void skorMinim() {
        ...
        if(SkorMinim >= 70){
            Toast.makeText(L6Activity.this, "Anda bisa lanjut ke LEVEL 7", Toast.LENGTH_LONG).show();

            SharedPreferences preferences = getSharedPreferences("PREFS6",0);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("SkorLulus6", SkorMinim);
            editor.apply();
            ...
            Toast.makeText(L6Activity.this, "Minimal skor untuk lanjut level 7 adalah \b70\b", Toast.LENGTH_LONG).show();
            finish();
        }
    }

    private void submitSkor(Nilai nilai_6) {
        /**
         ...
         */
        //ubah
        nilai6.setSkor_6(jumlahSkor);
        database.child(nilai_6.getNamaUser()).child("level 6").setValue(nilai_6.getSkor_6());
    }
