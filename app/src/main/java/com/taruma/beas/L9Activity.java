...
public class L9Activity extends AppCompatActivity {
    ...
    //FIREBASE
    public static final String EXTRA_NILAI9 = "extra_nilai9";
    private Nilai nilai9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nilai9 = new Nilai();
        nilai9 = getIntent().getParcelableExtra("extra-nilai9");
    ...
    private void ubahGambar() {
        ...
        //ubah
        jawaban = soal.getPertanyaan_salapan(x);
        cekPhoto();
    ...
    private void cekPhoto() {
        if(jawaban.equals("hordéng")){
            mPhoto = "hordeng";
        } else if (jawaban.equals("kéong")) {
            mPhoto = "keong";
        } else if (jawaban.equals("merdéka")) {
            mPhoto = "merdeka";
        } else if (jawaban.equals("téras")) {
            mPhoto = "teras";
        } else{
            mPhoto = jawaban;
        }
    ...
    private void skorMinim() {
        ...
        if(SkorMinim >= 70){
            Toast.makeText(L9Activity.this, "Anda bisa lanjut ke LEVEL 10", Toast.LENGTH_LONG).show();

            SharedPreferences preferences = getSharedPreferences("PREFS9",0);
            SharedPreferences.Editor editor = preferences.edit();
            editor.putInt("SkorLulus9", SkorMinim);
            editor.apply();
            ...
            Toast.makeText(L9Activity.this, "Minimal skor untuk lanjut level 10 adalah \b70\b", Toast.LENGTH_LONG).show();
            finish();
        }
    }

    private void submitSkor(Nilai nilai_9) {
        /**
         ...
         */
        //ubah
        nilai9.setSkor_9(jumlahSkor);
        database.child(nilai_9.getNamaUser()).child("level 9").setValue(nilai_9.getSkor_9());
    }
